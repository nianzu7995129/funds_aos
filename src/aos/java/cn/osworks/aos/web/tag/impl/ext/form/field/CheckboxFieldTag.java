...
/**
 * <b>CheckboxField标签实现类</b>
 * 
 * @author OSWorks-XC
 * @date 2014-04-24
 */
public class CheckboxFieldTag extends FormItemTagSupport {
	...
	public int doEndTag() throws JspException {
		...
		String jspString = mergeFileTemplate(EXTVM + "form/checkboxFieldTag.vm", tagDto);
		try {
