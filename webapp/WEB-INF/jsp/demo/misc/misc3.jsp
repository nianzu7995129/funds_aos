	...
	<aos:viewport layout="border">
		...
		<aos:tabpanel id="_tabpanel" region="center" activeTab="0" bodyBorder="0 0 0 0" tabBarHeight="30">
			...
			<aos:tab title="信用卡账户信息" id="_tab_account" layout="border">
				<aos:gridpanel id="_g_account" region="center" url="listAccounts.jhtml" onrender="_g_account_query"
				...
				<aos:formpanel id="_f_info" layout="column" labelWidth="70" header="false" region="south" height="120">
			...
			<aos:tab title="组织机构信息②" id="_tab_org2" layout="border">
				<aos:panel region="north" >
					<aos:formpanel id="_f_query2" layout="column" labelWidth="70" header="false" border="false">
						...
						<aos:combobox name="type_" fieldLabel="组织类型" dicField="org_type_" columnWidth="0.25" />
						<aos:combobox name="status_" fieldLabel="当前状态" dicField="enabled_" columnWidth="0.25" />
						<aos:textfield name="biz_code_" fieldLabel="业务对照码" labelWidth="80" columnWidth="0.25" />
						<aos:dockeditem xtype="button" text="查询" margin="0 0 0 10" onclick="_g_org_query2" icon="query.png" width="60"/>
						<aos:dockeditem xtype="button" text="重置" margin="0 0 0 10" onclick="AOS.reset(_f_query2);" icon="refresh.png" width="60"/>
					</aos:formpanel>
				</aos:panel>
				<aos:gridpanel id="_g_org2" region="center" url="listOrgs.jhtml" onrender="_g_org_query2">
					<aos:docked forceBoder="1 0 1 0">
